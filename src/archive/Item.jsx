...
// function ItemInteraction({ latitude, longitude, entity, location, setHpStatus, setDmgStatus, invStatus, setInvStatus, items, currentSave, updateCharacter }) {
...
//         updateCharacter(currentSave.name, currentSave.color, currentSave.x, currentSave.y, invStatus);
//       }
//     }
//   }
